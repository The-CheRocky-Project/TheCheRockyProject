...
def lambda_handler(event, context):
    ...
    try:
        ...
        result=rekognition.detect_custom_labels(ProjectVersionArn='arn:aws:rekognition:us-east-2:693949087897:project/redcards/version/redcards.2020-02-28T13.32.38/1582893159014',
            Image={
                'S3Object': {
                    'Bucket': bucket,
                    'Name': key
